...
export function Detail(){
  ...
  useEffect(() => {
    function getData() {
      fetch(`https://sujeitoprogramador.com/api-cripto/coin/?key=6fab84991e1d340c&symbol=${cripto}`)
  ...
  return(
    <div className={styles.container}>
      ...
      <section className={styles.content}>
        ...
        <p>
          <strong>Maior preço 24hr: </strong> {detail?.formatedHighprice}
        </p>
        <p>
          <strong>Menor preço 24hr: </strong> {detail?.formatedLowprice}
        </p>
        <p>
          <strong>Delta 24hr: </strong> 
